declare module '@cococart/react-native-bluetooth-escpos-printer' {
    ...
    namespace BluetoothManager {
        ...
        const EVENT_UNABLE_CONNECT = 'EVENT_UNABLE_CONNECT'
        ...
        function addListener(eventType: string): void

        function removeListeners(count: number): void
        ...
        function disconnect(address: string): Promise<string> // address of the device disconnected
    }
